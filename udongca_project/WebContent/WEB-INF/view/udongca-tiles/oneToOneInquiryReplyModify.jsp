...
<table border="1">
	...
	<tr>
		<td colspan="3"><textarea name="inquiryReply" rows="20" cols="90" placeholder="아직 답변이 달리지 않았습니다. 문의에 대한 답변을 남겨주세요..">${requestScope.oneToOneInquiry.inquiryReply }</textarea></td>
	</tr>
</table>
<div align="center">
